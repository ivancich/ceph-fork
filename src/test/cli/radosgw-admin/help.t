  ...
  commands:
    ...
    bucket versioning enable   enable bucket versioning on a non-versioned or versioning-suspended bucket
    bucket versioning suspend  suspend bucket versioning on a versioning-enabled bucket
